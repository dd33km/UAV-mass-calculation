...
class DroneVisualizer:
    ...
    def embed_figure_in_tkinter(self, figure: plt.Figure, parent_frame):
        ...
        if not TKINTER_AVAILABLE or FigureCanvasTkAgg is None:
            # Сохраняем как изображение и возвращаем None
            temp_file = "/images/photo1764589698.jpg"
            self.save_figure(figure, temp_file)
            return None
    ...
    def save_figure(self, figure: plt.Figure, filename: str):
        ...
        """
        figure.savefig(filename, dpi=300, bbox_inches='tight', facecolor='#2b2b2b')